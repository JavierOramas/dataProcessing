...
def verify_valid_overlapping(entry, i, providerName, procedureCodeId, providerId):
    ...
    if procedure in [150582, 194640] and i[procedureCodeId] in [150582, 194640,255975]:
        return True
    if procedure in [150580] and i[procedureCodeId] in [150582, 194640, 255975]:
        return True
...
def process(fix=False):
    ...
    data_filter = [i in valid for i in data.ProcedureCodeId]
